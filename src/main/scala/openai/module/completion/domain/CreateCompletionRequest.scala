...
/** @see
  ...
  *   from the beginning of a new document. Defaults value: <|endoftext|>.
  * @param suffix
  ...
  *   length. Most models have a context length of 2048 tokens (except for the
  *   newest models, which support 4096). Default value: 16.
  * @param temperature
  ...
  *   max_tokens and stop. Default value: 1.
  * @param stream
  *   Whether to stream back partial progress. If set, tokens will be sent as
  *   data-only server-sent events as they become available, with the stream
  *   terminated by a data: [DONE] message. Default value: false.
  * @param logprobs
  ...
  *   response. The maximum value for logprobs is 5. If you need more than this,
  ...
  *   n specifies how many to return – best_of must be greater than n. Note:
  ...
  *   settings for max_tokens and stop. Default value: 1.
  * @param logitBias
  ...
  *   selection of the relevant token. As an example, you can pass {"50256":
